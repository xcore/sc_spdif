...
app_example_tx Quick Start Guide
--------------------------------
...
++++++++++++++++++++++++++++++++
   ...
   #. Click on the ``app_example_tx`` item in the Explorer pane then click on the build icon (hammer) in xTimeComposer. Check the console window to verify that the application has built successfully.
